class PreloaderScene extends Phaser.Scene {
  ...
  preload() {
    ...
    //carrega audios
    this.load.audio('moeda', ['assets/audios/gema.ogg', 'assets/audios/gema.mp3']);
    this.load.audio('passos', ['assets/audios/passos.ogg', 'assets/audios/passos.mp3']);
    this.load.audio('morte', ['assets/audios/morte.ogg', 'assets/audios/morte.mp3']);
    this.load.audio('trilha-jogo', ['assets/audios/trilinha5-loop.ogg', 'assets/audios/trilinha5-loop.mp3']);
    this.load.audio('trilha-espera', ['assets/audios/trilinha2.ogg', 'assets/audios/trilinha2.mp3']);
