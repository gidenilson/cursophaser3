...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.physics.add.overlap(this.grupoMoedas, this.beth, (a, b) => this.colisoes.bethMoedas(b))

    //colisao com o Inimigo
    this.physics.add.overlap(this.inimigo, this.beth, (a, b) => this.colisoes.bethInimigo())
